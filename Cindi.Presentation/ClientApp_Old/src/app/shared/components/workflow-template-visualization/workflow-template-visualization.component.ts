...
@Component({
  selector: "cindi-workflow-template-visualization",
  templateUrl: "./workflow-template-visualization.component.html",
  styleUrls: ["./workflow-template-visualization.component.scss"]
})
export class WorkflowTemplateVisualizationComponent implements OnInit {
  name = "Angular 5";
  ...
  set workflowTemplate(template) {
    this._workflowTemplate = template;
  ...
  generateGraph(): Graph {
    if (this._workflowTemplate != undefined) {
      ...
      /* var foundStepTemplate = this._appState.getStepTemplateDef(
        this._workflowTemplate.startingStepTemplateReference
      );*/
